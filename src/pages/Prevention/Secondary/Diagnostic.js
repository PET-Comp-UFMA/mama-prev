            ...
            <ScrollView style={styles.container}>
                <View style={styles.textContainer}>
                    <Text style={styles.text}>
                        Refere-se às ações de diagnóstico para a identificação de casos de câncer na fase inicial e lesões de indivíduos sintomáticos.
                    </Text>
                    <Text style={styles.text}>
                ...
                <View style={styles.textContainer}>
                    ...
                    <Text style={styles.text}>
                        Podem ser realizadas por ações de educação para mudar conhecimentos e atitudes sobre o câncer de mama, além de desconstruir mitos sobre a doença.
                    </Text>
                    <Text style={styles.text}>
                        Essas estratégias podem ocorrer por meio de medidas de comunicação em massa (campanhas), com melhoria do conhecimento e das atitudes sobre câncer em geral, mediante intervenções educativas individuais, capacitação de profissionais de saúde que realizam o atendimento e demais profissionais de saúde da atenção primária que participem do atendimento ou das atividades educativas para essa população.
                    </Text>
                </View>
                <View style={styles.imgContainer}>
                ...
                <View style={styles.textContainer}>
                    ...
                    <Text style={styles.text}>                     
                        Caracteriza-se por informar a população feminina sobre as mudanças habituais das mamas em diferentes momentos do ciclo de vida e a divulgação dos principais sinais e sintomas do câncer de mama.
                    </Text>
                    <Text style={styles.text}>
                        Além de estimular às mulheres a procurarem os profissionais de saúde sempre que apresentarem dúvidas relacionadas às alterações suspeitas na mama.
                    </Text>
                </View>
                <View style={styles.imgContainer}>
